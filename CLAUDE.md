...
| `robotracker2/` | App de escritorio Kivy: editor visual del `robotraca.json` de cada canción (play/stop, mute, canal vocoder, efectos por canal, knobs, pads, fondo slideshow, pantalla live). |
